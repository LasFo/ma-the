...
valid, it finally executes the remaining \code{readTVar} operation in order to modify the 
...
overwritten. This is the reason the \code{readTVar} operations can not 
be delayed longer. 
