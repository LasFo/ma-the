...
critical for \code{transaction1}, \code{transaction1} needs to be rolled back.



%TODO explain why the rollback is needed bind monad
...
\end{figure}
Our aim is to delay the execution of \code{readTVar} as far as possible to avoid reduce to time that
...
%TODO explain delay to commit phase. limmitation of approach explained in chapter 3
