...
tests, the costs per transaction should not matter for STMLA (and STMWSL). The GHC and Project library on the other hand 
...
An explanation and a possible solution for the poor performance of STMWSL is givin in \textbf{REF TO FUTURE WORK}.
