...
hand requires synchronization between the threads. Lock based synchronization concepts yield the problem of deadlocks and
lock-free primitives are often hard to use. Thus software transactions were developed, a way to avoid both of these problems 
