...
as a Haskell library that makes use of C primitives and provides a clear interface. 
In this thesis I analyze the problems that lead to unnecessary rollbacks.  
