...
semantics. Although there is no formal prove that the alternative implementation (and the GHC implementation) 
...
a memory overhead and more important it avoids the necessity to look up values in the logs. They made 
...
present a concept that engages this problem. They present a concept that automatically creates 
...
The concept to provide an implementation that avoids the problems is presented Chapter \ref{Chapter2}.
